...
QUESTION = [
  ...
  "BonusQ1 What anime is the Character Willy Tybur from?",
  "BonusQ2 How many filler epsiodes are in All of Naruto?",
  "BonusQ3 Which team did Karasuno have to beat to get to the Nationals?",
  "BonusQ4 Who is the lion Tamer in Buggy's Crew (One Piece)?",
  "BonusQ5 Who was the second Kazekage (Naruto)?"
  ]
ANSWER = [
  ...
  "1.Death Note, 2.Vinland Saga, 3.Attack on Titan",
  "1. 275, 2.312, 3.195",
  "1.Inarizaki, 2.Aoba Johsai, 3.Shiratorizawa",
  "1.Cabaji, 2.Mohji, 3.Galdino",
  "1.Shamon, 2.Sandaime Kazekage, 3.Rasa"
...
("   ")
if points == 10:
  print ("You have got 10/10 you will be asked 5 bonus questions")
  time.sleep(0.5)
  print("  ")
  print (QUESTION[10])
  i=0
  ...
  time.sleep(3)
  print("{} got {} out of 15".format(user_name,points))
